      ...
      <div className="max-w-sm w-full">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6 shadow-sm">
          ...
          <div className="space-y-3">
            ...
            <button
              disabled
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700/50 rounded-lg text-neutral-400 dark:text-neutral-500 cursor-not-allowed"
            >
              ...
              Microsoft Workspace — Coming Soon
            </button>
          </div>
