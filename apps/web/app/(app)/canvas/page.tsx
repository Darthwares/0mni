...
const TEMPLATES: { name: string; description: string; content: any }[] = [
  ...
  },
  {
    ...
    description: 'Reflect on the last sprint',
    content: [
      ...
      { type: 'heading', content: [{ type: 'text', text: 'Action Items' }], props: { level: 2 } },
      { type: 'checkListItem', content: [{ type: 'text', text: '' }], props: { checked: false } },
      { type: 'heading', content: [{ type: 'text', text: 'Key Metrics' }], props: { level: 2 } },
      { type: 'paragraph', content: [{ type: 'text', text: 'Velocity: | Completed: | Carried over: ' }] },
    ],
  },
  {
    name: 'OKRs',
    ...
    content: [
      ...
      { type: 'paragraph', content: [{ type: 'text', text: 'Describe the objective.' }] },
      { type: 'heading', content: [{ type: 'text', text: 'Key Results' }], props: { level: 3 } },
      { type: 'checkListItem', content: [{ type: 'text', text: 'KR 1: ' }], props: { checked: false } },
      { type: 'checkListItem', content: [{ type: 'text', text: 'KR 2: ' }], props: { checked: false } },
      { type: 'checkListItem', content: [{ type: 'text', text: 'KR 3: ' }], props: { checked: false } },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', content: [{ type: 'text', text: 'What is the background and motivation?' }] },
      ...
      { type: 'paragraph', content: [{ type: 'text', text: 'Chosen option and rationale.' }] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', content: [{ type: 'text', text: 'What user problem are we solving?' }] },
      { type: 'heading', content: [{ type: 'text', text: 'User Stories' }], props: { level: 2 } },
      { type: 'bulletListItem', content: [{ type: 'text', text: 'As a [user], I want to [action] so that [benefit].' }] },
      ...
      { type: 'bulletListItem', content: [{ type: 'text', text: '' }] },
      { type: 'heading', content: [{ type: 'text', text: 'Mockups / Wireframes' }], props: { level: 2 } },
      { type: 'paragraph', content: [{ type: 'text', text: '' }] },
    ],
  },
  {
    ...
    content: [
      { type: 'heading', content: [{ type: 'text', text: 'Runbook: [Service Name]' }], props: { level: 1 } },
      { type: 'heading', content: [{ type: 'text', text: 'Overview' }], props: { level: 2 } },
      { type: 'paragraph', content: [{ type: 'text', text: 'What this service does and who owns it.' }] },
      { type: 'heading', content: [{ type: 'text', text: 'Prerequisites' }], props: { level: 2 } },
      { type: 'bulletListItem', content: [{ type: 'text', text: 'Access to: ' }] },
      { type: 'bulletListItem', content: [{ type: 'text', text: 'Tools needed: ' }] },
      { type: 'heading', content: [{ type: 'text', text: 'Common Issues' }], props: { level: 2 } },
      { type: 'heading', content: [{ type: 'text', text: 'Issue: [Name]' }], props: { level: 3 } },
      { type: 'paragraph', content: [{ type: 'text', text: 'Symptoms:' }] },
      { type: 'paragraph', content: [{ type: 'text', text: 'Resolution steps:' }] },
      { type: 'numberedListItem', content: [{ type: 'text', text: '' }] },
      { type: 'heading', content: [{ type: 'text', text: 'Escalation' }], props: { level: 2 } },
      { type: 'paragraph', content: [{ type: 'text', text: 'Contact: | Slack: | PagerDuty: ' }] },
    ],
  },
]
